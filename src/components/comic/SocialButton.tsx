...
/**
 * The two social accounts, in one place. Both the cover and the back cover
 * print these buttons (design-doc §4 and §9 — the bookends of the issue), and
 * a URL or an icon path that exists twice is a URL that will eventually differ
 * in one of them.
 */
const NETWORKS = {
  github: {
